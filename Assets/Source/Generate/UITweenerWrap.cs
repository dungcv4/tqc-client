...
public class UITweenerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("get_amountPerDelta", get_amountPerDelta);
		L.RegFunction("get_tweenFactor", get_tweenFactor);
		L.RegFunction("set_tweenFactor", set_tweenFactor);
		L.RegFunction("get_direction", get_direction);
	...
	static int get_amountPerDelta(IntPtr L)
	{
		try
		{
			...
			float o = obj.get_amountPerDelta();
	...
	static int get_direction(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UITweener obj = (UITweener)ToLua.CheckObject<UITweener>(L, 1);
			AnimationOrTween.Direction o = obj.get_direction();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
