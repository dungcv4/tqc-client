...
//   Extracted: tools/extract_all_shaders.py → work/06_ghidra/shader_dumps/Spine_Skeleton/
//   Reference GLSL: work/06_ghidra/shader_dumps/Spine_Skeleton/GLES20_sub0.glsl
//   Fragment template: tex_color (transcribed op-for-op from GLSL main())
