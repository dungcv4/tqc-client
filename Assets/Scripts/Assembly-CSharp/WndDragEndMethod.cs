// Source: Ghidra work/06_ghidra/decompiled_full/WndDragEndMethod/ (4 .c)
// String literal #3461 = "BtnDragEnd_CallBack"
	...
	public override void InitComponent(WndForm wnd)
	{
		if (wnd != null && !string.IsNullOrEmpty(_methodName))
		{
			...
			else
			{
				...
				_method = wndType.GetMethod("BtnDragEnd_CallBack", types);
				if (_method != null)
				{
					_wnd = wnd;
