// Source: Ghidra work/06_ghidra/decompiled_full/WndEnterMethod/ (3 .c)
// No WndForm_Lua branch — direct C# WndForm method lookup only.
// Method signature: (Component, PointerEventData)
