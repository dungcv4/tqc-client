...
--require "misc.strict"
-- SGC compat: original LuaJIT bytecode used closure env tables. LJD decompile
-- preserved `_env.X` references (see Common/SgzFunctions.lua:317). Alias to _G
-- so `_env.X = ...` writes to global scope (matches bytecode semantic).
_env = _G
